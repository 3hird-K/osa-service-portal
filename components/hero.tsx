  ...
  return (
    <section className="flex flex-col items-center justify-center text-center gap-8 px-6 pt-[-1rem] mt-1 pb-5 sm:gap-10 sm:py-24">
      ...
      <div className="flex w-full max-w-4xl flex-col items-center space-y-6">
        <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl leading-[1.1]">
          OSA Service Portal
        </h1>
        ...
        <div className="w-full max-w-[calc(100vw-2rem)] sm:max-w-md pt-4 mx-auto">
          <form
            onSubmit={handleSearch}
            className="group relative flex items-center p-1 bg-muted/40 border border-border/50 rounded-full focus-within:border-primary/50 focus-within:ring-4 focus-within:ring-primary/5 transition-all duration-300"
          >
            ...
            <input
              ...
              className="flex-1 min-w-0 bg-transparent border-none outline-none text-xs sm:text-sm font-medium placeholder:text-muted-foreground/60 h-9 sm:h-10"
            />
            <Button
              type="submit"
              size="sm"
              className="rounded-full px-3 sm:px-4 h-9 sm:h-10 font-bold tracking-tight shadow-lg shadow-primary/20 cursor-pointer text-xs sm:text-sm shrink-0"
            >
              Track <ArrowRight size={14} className="ml-1 sm:ml-2" />
            </Button>
          </form>
